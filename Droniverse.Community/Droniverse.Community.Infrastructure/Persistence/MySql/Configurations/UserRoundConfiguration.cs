...
public class UserRoundConfiguration : IEntityTypeConfiguration<UserRound>
{
    public void Configure(EntityTypeBuilder<UserRound> builder)
    {
        ...
        builder.Property(ur => ur.ExecutionTime).HasColumnType("float");
        builder.Property(ur => ur.NumberOfSteps).HasColumnType("int");
        builder.Property(ur => ur.PathLength).HasColumnType("float");
        ...
        builder.Property(ur => ur.SubmittedAt).HasColumnType("datetime");
    }
}
