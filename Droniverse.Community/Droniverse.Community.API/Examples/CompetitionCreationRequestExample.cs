    ...
    public class CompetitionCreationRequestExample : IMultipleExamplesProvider<CompetitionCreationRequest>
    {
        public IEnumerable<SwaggerExample<CompetitionCreationRequest>> GetExamples()
        {
            ...
            yield return SwaggerExample.Create(
                ...
                {
                    NameVN = "Cuộc thi lập trình Drone 2027",
                    NameEN = "Drone Programming Competition 2027",
                    ...
                    VisibleAt = DateTime.Parse("2027-12-25T00:00:00Z"),
                    RegistrationStartDate = DateTime.Parse("2027-01-01T00:00:00Z"),
                    RegistrationEndDate = DateTime.Parse("2027-01-09T23:59:59Z"),
                    StartDate = DateTime.Parse("2027-01-10T00:00:00Z"),
                    EndDate = DateTime.Parse("2027-01-20T23:59:59Z"),
                    ResultPublishedAt = DateTime.Parse("2027-01-21T00:00:00Z"),
            ...
            yield return SwaggerExample.Create(
                ...
                new CompetitionCreationRequest
                {
                    NameVN = "Giải đấu Drone Racing 2027",
                    NameEN = "Drone Racing Championship 2027",
                    DescriptionVN = "Giới hạn 50 người",
                    DescriptionEN = "Limited to 50 participants",
                    RuleContent = "Rules...",
                    MaxParticipants = 50,

                    VisibleAt = DateTime.Parse("2027-01-25T00:00:00Z"),
                    RegistrationStartDate = DateTime.Parse("2027-02-01T00:00:00Z"),
                    RegistrationEndDate = DateTime.Parse("2027-02-10T23:59:59Z"),
                    StartDate = DateTime.Parse("2027-02-15T00:00:00Z"),
                    EndDate = DateTime.Parse("2027-02-28T23:59:59Z"),
                    ResultPublishedAt = DateTime.Parse("2027-03-01T00:00:00Z"),
            ...
            yield return SwaggerExample.Create(
                ...
                new CompetitionCreationRequest
                {
                    NameVN = "Marathon lập trình Drone 2027",
                    NameEN = "Drone Programming Marathon 2027",
                    DescriptionVN = "Không giới hạn",
                    DescriptionEN = "Unlimited participants",
                    RuleContent = "Rules...",
                    MaxParticipants = null,

                    VisibleAt = DateTime.Parse("2027-02-20T00:00:00Z"),
                    RegistrationStartDate = DateTime.Parse("2027-03-01T00:00:00Z"),
                    RegistrationEndDate = DateTime.Parse("2027-03-15T23:59:59Z"),
                    StartDate = DateTime.Parse("2027-03-20T00:00:00Z"),
                    EndDate = DateTime.Parse("2027-03-25T23:59:59Z"),
                    ResultPublishedAt = DateTime.Parse("2027-03-26T00:00:00Z"),
            ...
            yield return SwaggerExample.Create(
                ...
                new CompetitionCreationRequest
                {
                    NameVN = "Giải vô địch Drone Quốc gia 2027",
                    NameEN = "National Drone Championship 2027",
                    DescriptionVN = "5 rounds trong 2 tháng",
                    DescriptionEN = "5 rounds over 2 months",
                    RuleContent = "Rules...",
                    MaxParticipants = 200,

                    VisibleAt = DateTime.Parse("2027-03-20T00:00:00Z"),
                    RegistrationStartDate = DateTime.Parse("2027-04-01T00:00:00Z"),
                    RegistrationEndDate = DateTime.Parse("2027-04-15T23:59:59Z"),
                    StartDate = DateTime.Parse("2027-05-01T00:00:00Z"),
                    EndDate = DateTime.Parse("2027-06-30T23:59:59Z"),
                    ResultPublishedAt = DateTime.Parse("2027-07-01T00:00:00Z"),
            ...
            yield return SwaggerExample.Create(
                ...
                new CompetitionCreationRequest
                {
                    ...
                    VisibleAt = DateTime.Parse("2027-01-01T00:00:00Z"),
                    RegistrationStartDate = DateTime.Parse("2027-01-10T00:00:00Z"),
                    RegistrationEndDate = DateTime.Parse("2027-01-05T00:00:00Z"), // ❌ sai
                    StartDate = DateTime.Parse("2027-01-15T00:00:00Z"),
                    EndDate = DateTime.Parse("2027-01-20T00:00:00Z"),
                    ResultPublishedAt = DateTime.Parse("2027-01-21T00:00:00Z"),
