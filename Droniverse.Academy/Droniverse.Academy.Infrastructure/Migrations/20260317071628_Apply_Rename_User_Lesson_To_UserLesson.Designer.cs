...
namespace Droniverse.Academy.Infrastructure.Migrations
{
    ...
    [Migration("20260317071628_Apply_Rename_User_Lesson_To_UserLesson")]
    partial class Apply_Rename_User_Lesson_To_UserLesson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Droniverse.Academy.Domain.Entities.Enrollment", b =>
                {
                    ...
                    b.ToTable("Enrollment", null, t =>
                        {
                            t.HasCheckConstraint("CK_Enrollment_Status", "`Status` IN (0,1,2)");
                        });
                });
