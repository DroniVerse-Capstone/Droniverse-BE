...
namespace Droniverse.Academy.Infrastructure.Migrations
{
    ...
    [Migration("20260422090116_Update_Web_Simulator")]
    partial class Update_Web_Simulator
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Lesson", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Lesson_Type", "`Type` IN ('THEORY', 'QUIZ', 'LAB', 'WEB', 'VR')");
                        });
                });
                    ...
                    b.ToTable("WebSimulator", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_WebSimulator_Type", "`Type` IN ('Physic', 'LabPhysic')");
                        });
                });
