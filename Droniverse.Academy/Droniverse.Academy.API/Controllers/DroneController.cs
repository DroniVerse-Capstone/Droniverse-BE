...
public class DroneController : ControllerBase
{
    ...
    public async Task<IActionResult> GetDrones()
    {
        try
        {
            ...
            return Ok(SuccessResponse<IEnumerable<DroneClientViewDTO>>.Create(drones, "L?y danh sách drone thành công."));
        }
        catch (Exception ex)
        {
    ...
    public async Task<IActionResult> GetDroneById(Guid droneId)
    {
        try
        {
            ...
            return Ok(SuccessResponse<DroneClientViewDTO>.Create(drone, "L?y chi ti?t drone thành công."));
        }
        catch (Exception ex)
        {
